...
- Поддержка Qwen CustomVoice через текст, язык, необязательный speaker и
  естественную инструкцию стиля.
...
Клонирование голоса - запланированная возможность worker, но пока не
поддерживаемый публичный сценарий.
...
- Пока нет публичного request flow для клонирования голоса.
