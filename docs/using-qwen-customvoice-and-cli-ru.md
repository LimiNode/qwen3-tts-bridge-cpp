...
| `/voices` | Выводит зарегистрированные Base-профили, если worker их предоставляет. |
...
У Base worker с настроенным реестром `/voice <id>` вместо этого выбирает
зарегистрированный профиль клонированного голоса, а `/voices` выводит доступные
ID. Создание профиля и отличие постоянного профиля от одноразового WAV-запроса
описаны в [руководстве по локальному клонированию](voice-clone-ru.md).
