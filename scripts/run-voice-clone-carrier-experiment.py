"""Test whether a short carrier phrase stabilizes Base ICL target speech."""
...
CARRIERS = (
    ("baseline", ""),
    ("carrier-itak", "\u0418\u0442\u0430\u043a."),
    ("carrier-gotovo", "\u0413\u043e\u0442\u043e\u0432\u043e."),
    ("carrier-system", "\u0421\u0438\u0441\u0442\u0435\u043c\u0430 \u0430\u043a\u0442\u0438\u0432\u0438\u0440\u043e\u0432\u0430\u043d\u0430."),
)
...
def main() -> int:
    ...
    for index, target_text in enumerate(DEFAULT_TEXTS, start=1):
        for label, carrier_text in CARRIERS:
            full_text = _join_carrier(carrier_text, target_text)
            results.append(
                _generate_one(
                    model=model,
                    np=np,
    ...
    summary = {
        "schema_version": 1,
        "purpose": "Base ICL carrier phrase listening experiment before crop",
        ...
        "variants": [
            {"label": label, "carrier_text": carrier}
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", default="tmp/voice-clone-carrier")
...
def _join_carrier(carrier: str, target: str) -> str:
    return f"{carrier} {target}".strip()
